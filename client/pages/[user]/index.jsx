    ...
    <div class="max-w-2xl mx-auto">
      <div class="px-3 py-2">
        <div class="flex flex-col gap-1 text-center">
          <a
            class="block mx-auto bg-center bg-no-repeat bg-cover w-20 h-20 rounded-full border border-gray-400 shadow-lg"
            href=""
        ...
        <div class="flex justify-center gap-2 my-5">
          <button class="bg-pink-500 px-10 py-2 rounded-full text-white shadow-lg">
            Follow
          </button>
